 ...
 * @info: A struct containing potential arguments. Maintains a consistent
 *        function prototype.
 * Return: Always 0
 */
...
/**
 * _myalias - Emulate the alias built-in command (man alias).
 * @info: A structure containing potential arguments. Maintains a consistent
 *        function prototype.
 * Return: Always 0
 */
